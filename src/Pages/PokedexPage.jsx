...
const PokedexPage = () => {
    ...
    return (
        <div className='card__principal'>
            ...
            <div className='btn'>
                <button className='btn__before' onClick={() => setCurrentPage(currentPage - 1)}>before</button>
                <button className='btn__after' onClick={() => setCurrentPage(currentPage + 1)}>after</button>
            </div>
        </div>
